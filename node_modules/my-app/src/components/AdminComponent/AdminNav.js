        ...
        <>
            <nav className="main-header navbar navbar-expand navbar-white navbar-light">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item d-none d-sm-inline-block">
                        <Link to ="/admin/contact-info" className="nav-link">Contact</Link>
                    </li>
                    <li className="nav-item d-none d-sm-inline-block">
                        <Link to ="/admin/booking-details" className="nav-link">Booking-Detail </Link>
                    </li>
                    <li className="nav-item d-none d-sm-inline-block">
                        <Link to ="/admin/create-package" className="nav-link">Create Package</Link>
                    </li>
                    <li className="nav-item d-none d-sm-inline-block">
                        <Link to ="/admin/package-list" className="nav-link">Package Detail</Link>
                    </li>
                </ul>
